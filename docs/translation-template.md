...
```json
{
  ...
  "name": "Mochtario Dwi Wahyudi", // Full name (first name and last name)
  "description": "Software Engineer", // Your professional title or role (e.g., Software Engineer)
  ...
  "contacts": [
    {
      ...
      "url": "https://github.com/skymochtar", // URL to open when the contact icon button is tapped, accepts various URL schemes (sms, tel, mailto, https, file)
      "icon": {
